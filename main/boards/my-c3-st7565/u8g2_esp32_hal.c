...
uint8_t u8g2_esp32_spi_byte_cb(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr) {
    ESP_LOGD(TAG, "spi_byte_cb: Received a msg: %d, arg_int: %d, arg_ptr: %p", msg, arg_int,
             arg_ptr);
    switch (msg) {
        ...
        case U8X8_MSG_BYTE_INIT: {
            ...
            if (spi_err != ESP_OK && spi_err != ESP_ERR_INVALID_STATE) {
                ESP_LOGE("u8g2_hal", "SPI Init failed with error: %d", spi_err);
...
uint8_t u8g2_esp32_gpio_and_delay_cb(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr) {
    ESP_LOGD(TAG, "gpio_and_delay_cb: Received a msg: %d, arg_int: %d, arg_ptr: %p", msg, arg_int,
             arg_ptr);
